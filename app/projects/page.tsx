              ...
              <article key={project.id} className="panel p-6 md:p-7">
                <div className="grid gap-4 md:grid-cols-[auto_1fr_auto] md:items-start">
                  ...
                  <div className="flex flex-col items-start gap-3 md:items-end">
                    ...
                    {project.demoUrl && (
                      <Link href={project.demoUrl} className="pill-link primary text-xs">
                        Try it
                      </Link>
                    )}
                  </div>
        ...
        <section className="scroll-chapter top">
          <div className="shell chapter-stack">
            <div className="grid gap-4">
              {projectItems.slice(2).map((project, index) => (
                <article key={project.id} className="panel p-6 md:p-7">
                  <div className="grid gap-4 md:grid-cols-[auto_1fr_auto] md:items-start">
                    <span className="kicker">{String(index + 3).padStart(2, "0")}</span>
